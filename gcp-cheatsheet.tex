...
\node [mybox] (box){%
    ...
    {\color{blue} \textbf{Cloud Storage:}}\\ 
        ...
        \begin{itemize}
            \item \textbf{Storage Transfer Service}: move data from other cloud providers or from an on-premise storage\\
            \item \textbf{Transfer Appliance}: securely migrate large data (> 10TB) using hardware appliance\\
        \end{itemize}    
